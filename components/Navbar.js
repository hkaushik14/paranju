...
//         </ul> */}
//         <div>
//           {/* {session && <Link href={"/dashboard"}><button className='text-white rounded-2xl bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5'>Dashboard</button></Link>} */}
          
//           {/* {session && <button className='text-white rounded-2xl bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5' onClick={()=>{signOut()}}>Logout</button>} */}

//           {!session &&<Link href={"/login"}>
//           <button className='text-white rounded-2xl bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5'>Login</button></Link>}
//         </div>
//     </nav>
//   )
// }
